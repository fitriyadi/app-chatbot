...
<head>
  ...
  <title>Sistem Chatbot dengan metode QA</title>
  ...
  <div class="wrapper">
      ...
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
            ...
            <a href="logout.php" onclick="return confirm('Apakah anda yakin akan Log Out?')" class="dropdown-item">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="#" class="brand-link">
        <span class="brand-text font-weight-light">Admin - Chatbot</span>
      </a>
