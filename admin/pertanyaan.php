...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      ...
      <div class="col-sm-1">
        <a href="?hal=pertanyaan_olah" style="float: right;" class="btn btn-block bg-gradient-primary btn-sm">Tambah</a>
      </div><!-- /.col -->
    </div><!-- /.row -->
  </div><!-- /.container-fluid -->
</div>
                ...
                while ($data=mysqli_fetch_assoc($result)) {
                  ...
                  <tr>
                    ...
                    <td width="20%">
                      ...
                      <a href="?hal=pertanyaan_olah&id=<?=$idpertanyaan; ?>" 
                        class="btn btn-icon btn-primary" title="Edit Data"><i class="fa fa-edit"></i> </a>

                        <a class="btn btn-danger" title="Hapus Data" href="pertanyaan_proses.php?hapus=<?=$idpertanyaan;?>" 
